...
if (document.location.hostname == "localhost") {
  ...
  var baseurl = "https://static.code4sa.org/women-municipalities/";
}

var container = document.getElementById('code4sa-women-index');

var pymParentScript = document.createElement( 'script' );
pymParentScript.type = 'text/javascript';
pymParentScript.text = "var pymParent = new pym.Parent('code4sa-women-index', '"
  + baseurl + "index.html', {});";
